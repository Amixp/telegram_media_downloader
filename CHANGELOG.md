...
- **Исправлено зависание программы при прерывании (Ctrl+C)**
  - При прерывании программы до начала обработки чатов могло возникнуть зависание
  - Добавлен таймаут 5 секунд на отключение Telegram клиента в session_manager.stop()
  - Если disconnect зависает, программа принудительно завершается через таймаут
  - Логирование: "Таймаут при отключении Telegram клиента, принудительное завершение"
  - Предотвращает бесконечное ожидание при сетевых проблемах или прерываниях
